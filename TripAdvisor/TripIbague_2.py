...
with open("tripadvisor_ibague_2.html", "r", encoding="utf-8") as f:
    html = f.read()
...
# Guardar en CSV
with open("atracciones_ibague_2.csv", "w", newline="", encoding="utf-8") as f:
    writer = csv.DictWriter(f, fieldnames=["Nombre", "Calificación", "Número de Reseñas", "Etiquetas"])
    writer.writeheader()
    writer.writerows(data)

print(f"✅ Extraídos {len(data)} registros y guardados en atracciones_ibague_2.csv")
